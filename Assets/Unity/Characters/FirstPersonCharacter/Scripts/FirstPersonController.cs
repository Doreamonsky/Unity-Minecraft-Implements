...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            ControlEvents.OnControllerInput += (InputData val) =>
            {
                m_Input = new Vector2(val.x, val.y);
            };

            ControlEvents.OnJumped += () =>
            {
        ...
        private void FixedUpdate()
        {
            ...
            var speed = m_IsWalking ? m_WalkSpeed : m_RunSpeed;
            ...
            RaycastHit hitInfo;
            Physics.SphereCast(transform.position, m_CharacterController.radius, Vector3.down, out hitInfo, m_CharacterController.height / 2f, 1 << LayerMask.NameToLayer("Block"), QueryTriggerInteraction.Ignore);
